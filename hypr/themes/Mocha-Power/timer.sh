...
# --- SOUND EFFECTS ---
SOUND_TIMER_DONE="${HOME}/.config/sounds/timer.mp3"
SOUND_WORK_START="${HOME}/.config/sounds/timer.mp3"
SOUND_BREAK_START="${HOME}/.config/sounds/timer.mp3"
SOUND_BREAK_END="${HOME}/.config/sounds/timer.mp3"
SOUND_COMPLETE="${HOME}/.config/sounds/timer.mp3"
